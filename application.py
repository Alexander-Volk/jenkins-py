...
<body id="sample">
  <div class="textColumn">
      <h1><font color="red">Congratulations</font> <br> <font color="purple">DevOps Engineer!!!</font></h1>
  ...
  <div class="linksColumn">
    ...
    <li><a href="http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/using-features.loggingS3.title.html">Working with Logs</a></li>
      ...
      <h2><font color="#2f4e60">Jen</font><font color="#d33530">k</font><font color="#2f4e60">ins</font>-<font color="#4f67be">Pyt</font><font color="#f8bb03">hon</font></h2>
      <img src="image.jpg">
  </div>
</body>
</html>
